...
export default function Level() {
    ...
    var DTWS_MEDIUM = checkPlayed(GAMEMODE_DIFFICULTY.DTWS_EASY) ? (checkPlayed(GAMEMODE_DIFFICULTY.DTWS_MEDIUM) ? DTWS_MEDIUM_PLAYED : DTWS_MEDIUM_NOT_PLAYED) : DTWS_MEDIUM_UNAVAILABLE;
    var DTWS_HARD = checkPlayed(GAMEMODE_DIFFICULTY.DTWS_MEDIUM) ? (checkPlayed(GAMEMODE_DIFFICULTY.DTWS_HARD) ? DTWS_HARD_PLAYED : DTWS_HARD_NOT_PLAYED) : DTWS_HARD_UNAVAILABLE;
    var DITD_EASY = checkPlayed(GAMEMODE_DIFFICULTY.DITD_EASY) ? DITD_EASY_PLAYED : DITD_EASY_NOT_PLAYED;
    var DITD_MEDIUM = checkPlayed(GAMEMODE_DIFFICULTY.DITD_EASY) ? (checkPlayed(GAMEMODE_DIFFICULTY.DITD_MEDIUM) ? DITD_MEDIUM_PLAYED : DITD_MEDIUM_NOT_PLAYED) : DITD_MEDIUM_UNAVAILABLE;
    var DITD_HARD = checkPlayed(GAMEMODE_DIFFICULTY.DITD_MEDIUM) ? (checkPlayed(GAMEMODE_DIFFICULTY.DITD_HARD) ? DITD_HARD_PLAYED : DITD_HARD_NOT_PLAYED) : DITD_HARD_UNAVAILABLE;
    var DBTW_EASY = checkPlayed(GAMEMODE_DIFFICULTY.DBTW_EASY) ? DBTW_EASY_PLAYED : DBTW_EASY_NOT_PLAYED;
    var DBTW_MEDIUM = checkPlayed(GAMEMODE_DIFFICULTY.DBTW_EASY) ? (checkPlayed(GAMEMODE_DIFFICULTY.DBTW_MEDIUM) ? DBTW_MEDIUM_PLAYED : DBTW_MEDIUM_NOT_PLAYED) : DBTW_MEDIUM_UNAVAILABLE;
    var DBTW_HARD = checkPlayed(GAMEMODE_DIFFICULTY.DBTW_MEDIUM) ? (checkPlayed(GAMEMODE_DIFFICULTY.DBTW_HARD) ? DBTW_HARD_PLAYED : DBTW_HARD_NOT_PLAYED) : DBTW_HARD_UNAVAILABLE;
